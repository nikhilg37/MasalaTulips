...
const PrivacyPolicy: React.FC = () => {
  useEffect(() => {
    ...
    document.title = 'Privacy Policy - Masala Tulips';
    
    // Update meta description
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Privacy Policy for Masala Tulips. Learn how we collect, use, and protect your information when you visit our website.');
    }
  }, []);
  ...
  return (
    <div className="legal-page">
      <div className="legal-content">
        ...
        <p>Welcome to Masala Tulips ("we," "our," or "us"). We are committed to protecting your privacy and ensuring you have a positive experience on our website. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website at <a href="https://masalatulips.nl">https://masalatulips.nl</a>.</p>
        ...
        <p>We use Google Analytics to understand how visitors interact with our website. Google Analytics uses cookies to collect information such as:</p>
        <ul>
          <li>Pages visited</li>
        ...
        <p>We use Google AdSense to display advertisements on our website. Google AdSense uses cookies to:</p>
        <ul>
        ...
        <p>We use several Google services:</p>
        <ul>
          <li><strong>Google Analytics:</strong> For website analytics and performance monitoring</li>
          <li><strong>Google AdSense:</strong> For displaying advertisements</li>
          <li><strong>Google Tag Manager:</strong> For managing website tags and tracking</li>
        </ul>
        <p>These services have their own privacy policies, which you can review at <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Google's Privacy Policy</a>.</p>

        <h3>4.2 Social Media Platforms</h3>
        <p>Our website may contain links to social media platforms (Instagram, YouTube, Pinterest). These platforms have their own privacy policies and data collection practices.</p>
        ...
        <ul>
          <li>Consent (for analytics and advertising cookies)</li>
          <li>Legitimate interests (for website functionality and security)</li>
