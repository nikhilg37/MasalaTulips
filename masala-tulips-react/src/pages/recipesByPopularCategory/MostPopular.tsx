...
const MostPopular: React.FC = () => {
  ...
  // Filter out Mint Chutney, Pulao, and Coconut Lemon Rice from most popular recipes
  const allRecipes = getAllRecipes();
  const popularRecipes = allRecipes.filter(recipe => 
    recipe.id !== 'mint-chutney' && recipe.id !== 'vegetable-pulao' && recipe.id !== 'kaayi-chitranna'
  );
